...
def getRHS(main,MZ,eqns,args=[],args_phys=[]):
  ...
  if (main.basis_args[0] == 'TensorDot_FV2'):
    #main.a.uR[:],main.a.uL[:],main.a.uU[:],main.a.uD[:],main.a.uF[:],main.a.uB[:] = main.basis.reconstructEdgesGeneral(main.a.a,main)
    main.a.uR_edge[:],main.a.uL_edge[:],main.a.uU_edge[:],main.a.uD_edge[:],main.a.uF_edge[:],main.a.uB_edge[:] = sendEdgesGeneralSlab(main.a.u[:,0,:,:,:,:,:,:,:],main.a.u[:,0,:,:,:,:,:,:,:],main.a.u[:,:,0,:,:,:,:,:,:],main.a.u[:,:,0,:,:,:,:,:,:],main.a.u[:,:,:,0,:,:,:,:,:],main.a.u[:,:,:,0,:,:,:,:,:],main)
    #main.a.uR[:],main.a.uL[:],main.a.uU[:],main.a.uD[:],main.a.uF[:],main.a.uB[:] = main.basis.reconstructEdgesGeneral(main.a.a,main)
    main.basis.reconstructEdgesGeneral(main.a.a,main)
